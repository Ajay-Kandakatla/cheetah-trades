...
NODES: list[Node] = [
    ...
    # AI ecosystem — power, grid, cooling, water, networking, AI software (2026-06-25)
    {"ticker": "WMB",   "name": "Williams Companies",      "sector": "Energy",         "sub_sector": "Midstream / behind-the-meter gas"},
    {"ticker": "ET",    "name": "Energy Transfer",         "sector": "Energy",         "sub_sector": "Midstream / data-center gas"},
    {"ticker": "LEU",   "name": "Centrus Energy",          "sector": "Energy",         "sub_sector": "Uranium enrichment (HALEU)"},
    {"ticker": "AES",   "name": "AES Corporation",         "sector": "Utilities",      "sub_sector": "Hyperscaler clean-energy PPAs"},
    {"ticker": "GEV",   "name": "GE Vernova",              "sector": "Industrials",    "sub_sector": "Gas turbines / grid transformers"},
    {"ticker": "ETN",   "name": "Eaton",                   "sector": "Industrials",    "sub_sector": "Grid-to-chip power & thermal"},
    {"ticker": "VRT",   "name": "Vertiv",                  "sector": "Industrials",    "sub_sector": "Data-center cooling & power"},
    {"ticker": "MOD",   "name": "Modine Manufacturing",    "sector": "Industrials",    "sub_sector": "Liquid-cooling chillers"},
    {"ticker": "TT",    "name": "Trane Technologies",      "sector": "Industrials",    "sub_sector": "HVAC / chillers / thermal"},
    {"ticker": "SPXC",  "name": "SPX Technologies",        "sector": "Industrials",    "sub_sector": "Adiabatic / modular DC cooling"},
    {"ticker": "NVT",   "name": "nVent Electric",          "sector": "Industrials",    "sub_sector": "Liquid-cooling distribution"},
    {"ticker": "PH",    "name": "Parker Hannifin",         "sector": "Industrials",    "sub_sector": "Cooling fittings / thermal"},
    {"ticker": "IR",    "name": "Ingersoll Rand",          "sector": "Industrials",    "sub_sector": "Flow / chiller / thermal"},
    {"ticker": "ECL",   "name": "Ecolab",                  "sector": "Materials",      "sub_sector": "Cooling water treatment"},
    {"ticker": "XYL",   "name": "Xylem",                   "sector": "Industrials",    "sub_sector": "Water tech / DC thermal"},
    {"ticker": "AWK",   "name": "American Water Works",     "sector": "Utilities",      "sub_sector": "Water utility / DC water"},
    {"ticker": "PNR",   "name": "Pentair",                 "sector": "Industrials",    "sub_sector": "Water treatment / DC cooling"},
    {"ticker": "EME",   "name": "EMCOR Group",             "sector": "Industrials",    "sub_sector": "Mission-critical MEP build"},
    {"ticker": "SMCI",  "name": "Super Micro Computer",    "sector": "Tech",           "sub_sector": "AI server racks / DLC"},
    {"ticker": "COMM",  "name": "CommScope",               "sector": "Tech",           "sub_sector": "Optical interconnect / networking"},
    {"ticker": "CRWV",  "name": "CoreWeave",               "sector": "Tech",           "sub_sector": "Hyperscale AI cloud / GPU DCs"},
    {"ticker": "NOW",   "name": "ServiceNow",              "sector": "Tech",           "sub_sector": "Enterprise AI orchestration"},
    {"ticker": "AI",    "name": "C3.ai",                   "sector": "Tech",           "sub_sector": "Enterprise AI applications"},
    {"ticker": "PATH",  "name": "UiPath",                  "sector": "Tech",           "sub_sector": "Agentic automation / RPA"},
    # Healthcare + Pharma
...
EDGES: list[Edge] = [
    ...
    # === AI ecosystem buildout — power, gas, grid, cooling, water, software (2026-06-25, deep-research) ===
    {"source": "WMB",  "target": "AMZN", "relation": "supplier_of",  "strength": 0.5,
     "evidence": "Williams $1.6B behind-the-meter gas generation dedicated to AI data centers (Williams IR, 2025)"},
    {"source": "ET",   "target": "AMZN", "relation": "supplier_of",  "strength": 0.5,
     "evidence": "Energy Transfer dedicated natural-gas supply to CloudBurst AI data center; 1.2 GW pipeline (ET, 2025)"},
    {"source": "AES",  "target": "MSFT", "relation": "supplier_of",  "strength": 0.6,
     "evidence": "AES top clean-energy PPA provider to hyperscalers; 11.8 GW signed agreements (AES IR, 2025)"},
    {"source": "LEU",  "target": "OKLO", "relation": "supplier_of",  "strength": 0.5,
     "evidence": "Centrus LOI to supply HALEU fuel for up to 5 Oklo Aurora powerhouses from 2029 (Centrus/Oklo, 2025)"},
    {"source": "GEV",  "target": "VST",  "relation": "supplier_of",  "strength": 0.7,
     "evidence": "GE Vernova gas turbines (sold out to ~2028, ~300% price rise) are the dispatchable-capacity bottleneck"},
    {"source": "GEV",  "target": "CEG",  "relation": "supplier_of",  "strength": 0.5,
     "evidence": "GE Vernova grid transformers/turbines for utilities scaling baseload for AI demand"},
    {"source": "VRT",  "target": "NVDA", "relation": "supplier_of",  "strength": 0.8,
     "evidence": "Vertiv liquid-cooling + power distribution reference-designed into NVIDIA GB200/Blackwell racks"},
    {"source": "VRT",  "target": "CRWV", "relation": "supplier_of",  "strength": 0.6,
     "evidence": "Vertiv thermal/power infrastructure deployed across hyperscale AI data centers"},
    {"source": "ETN",  "target": "NVDA", "relation": "supplier_of",  "strength": 0.6,
     "evidence": "Eaton grid-to-chip power + Boyd Thermal liquid cooling featured in NVIDIA AI reference designs"},
    {"source": "MOD",  "target": "NVDA", "relation": "supplier_of",  "strength": 0.6,
     "evidence": "Modine Airedale liquid-cooling chillers under $4B+ multi-year AI data-center contracts"},
    {"source": "TT",   "target": "NVDA", "relation": "supplier_of",  "strength": 0.6,
     "evidence": "Trane chillers + liquid CDUs (acquiring LiquidStack) specified for NVIDIA AI factories"},
    {"source": "NVT",  "target": "NVDA", "relation": "supplier_of",  "strength": 0.5,
     "evidence": "nVent liquid-cooling distribution units deployed at 2+ GW of hyperscale AI capacity"},
    {"source": "SPXC", "target": "CRWV", "relation": "supplier_of",  "strength": 0.4,
     "evidence": "SPX Marley OlympusMAX adiabatic cooling supplies high-density AI data centers"},
    {"source": "ECL",  "target": "CRWV", "relation": "supplier_of",  "strength": 0.4,
     "evidence": "Ecolab water-treatment + cooling chemistry (acquiring CoolIT) underpins AI DC cooling"},
    {"source": "XYL",  "target": "CRWV", "relation": "supplier_of",  "strength": 0.4,
     "evidence": "Xylem data-center thermal-management/water suite serves the AI buildout"},
    {"source": "AWK",  "target": "CRWV", "relation": "supplier_of",  "strength": 0.3,
     "evidence": "American Water (largest US water utility) supplies cooling-water demand at AI data centers"},
    {"source": "EME",  "target": "CRWV", "relation": "supplier_of",  "strength": 0.5,
     "evidence": "EMCOR mechanical/electrical/HVAC builds mission-critical AI facilities ($15.6B backlog)"},
    {"source": "COMM", "target": "NVDA", "relation": "supplier_of",  "strength": 0.4,
     "evidence": "CommScope optical interconnect / structured cabling links high-density NVIDIA AI clusters"},
    {"source": "SMCI", "target": "NVDA", "relation": "customer_of",  "strength": 0.8,
     "evidence": "Super Micro is a primary GB200/Blackwell rack integrator; ~70% direct-liquid-cooling share"},
    {"source": "CRWV", "target": "NVDA", "relation": "customer_of",  "strength": 0.9,
     "evidence": "CoreWeave is a top NVIDIA GPU buyer (43 DCs, 3.1 GW contracted) — concentrated NVDA dependency"},
    {"source": "NOW",  "target": "MSFT", "relation": "partner_with", "strength": 0.4,
     "evidence": "ServiceNow AI agents run with Azure OpenAI; enterprise AI orchestration on Microsoft cloud"},
    {"source": "AI",   "target": "MSFT", "relation": "partner_with", "strength": 0.4,
     "evidence": "C3.ai enterprise AI apps distributed on Azure under a multi-year Microsoft agreement"},
    {"source": "PATH", "target": "MSFT", "relation": "partner_with", "strength": 0.3,
     "evidence": "UiPath agentic automation integrated with Azure OpenAI / Microsoft Copilot ecosystem"},
