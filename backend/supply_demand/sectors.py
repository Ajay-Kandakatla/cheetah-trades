...
SECTORS: list[Sector] = [
    ...
    {
        "id": "power_grid",
        "label": "Electricity & Power (AI Grid)",
        "narrative": "US power demand inflecting after ~20 flat years — AI data centers, reshoring + electrification straining generation and the grid. Fed by nuclear (uranium) + natural gas; grid equipment is the bottleneck.",
        "etf": "XLU",
        "commodity": "",
        ...
        "gap_economics": {
            "demand_usd_bn": 500,
            "supply_usd_bn": 470,
            "unit": "annual US electricity retail revenue (~$490B base) + the AI data-center demand layer",
            "capex_to_close_usd_bn": 50,
            "years_to_close": "4–7",
            "key_constraint": "Dispatchable generation + grid interconnection — gas-turbine slots sold out to ~2028, large-power transformers 2+ yr lead, ~2.6 TW in interconnection queues",
            "notes": "First sustained US load growth since ~2005. New baseload is nuclear (uranium-fed) + gas; the bottleneck is grid equipment + interconnection, not fuel. Direct feeder dependency on the 'uranium' and 'oil_gas' sectors. Utilities with nuclear/gas (CEG, VST, NRG) can charge premium for 24/7 carbon-free MWh on hyperscaler PPAs.",
            "as_of": "2026-Q2",
