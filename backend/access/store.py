...
FEATURE_CATALOG: list[dict] = [
    ...
    # GEX Board (2026-07-17): cross-sectional dealer-gamma board — bullish vs
    # bearish names with their key nodes (call/put walls, zero-gamma flip,
    # magnet) + net GEX/VEX, off the nightly options-key snapshot. Owner-on
    # via added_in/VERSION.
