...
SYSTEM = (
    ...
    "- PLAIN LANGUAGE: your thesis/risks/what_would_change_it are read by "
    "non-technical people. NEVER echo internal field names, snake_case "
    "identifiers, or the words 'null'/'None'/'false'/'true' — translate them: "
    "is_buyable null/missing -> \"the scanner hasn't graded this stock's buy "
    "signal in the latest scan\"; is_buyable false -> \"the scanner's buy "
    "signal is OFF for this stock today\"; is_buyable true -> \"the scanner's "
    "buy signal is ON\"; high_vol_breakout false -> \"the breakout didn't "
    "have the required 1.5x volume behind it\"; qualifier/trend template -> "
    "\"the trend checklist\"; rs_rank -> \"relative strength rank\"; "
    "vol_dryup/is_drying_up -> \"volume drying up in the base (a good "
    "sign)\". Keep all numbers; drop all jargon. Anyone's mother should be "
