...
export const NEW_FEATURES: NewFeature[] = [
  ...
  { id: 'chart-maps-sort-progress', label: '📊 Chart Maps: sort the board by today\'s volume, volume-vs-normal, $ turnover, liquidity, conviction or RS — ranked across the whole scan, not just the tiles on screen — plus live ticker-by-ticker scan progress and a Re-scan button', addedAt: '2026-08-17', route: '/chart-maps' },
