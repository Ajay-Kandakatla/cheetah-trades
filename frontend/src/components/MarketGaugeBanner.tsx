...
export function MarketGaugeBanner() {
  ...
  return (
    <NavLink
      ...
      title={`Market Gauge: ${g.state_label} · ${g.score}/100. Click for the full pillar breakdown.`}
      aria-label={`Market gauge: ${g.state_label}, score ${g.score} of 100. Click for details.`}
    >
